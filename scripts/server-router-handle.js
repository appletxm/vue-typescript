...
function noMockFileMatched(filePath, res) {
  console.info('[req info mock no matched]', filePath, ' file not exist')
  res.set('content-type', 'application/json')
  res.send(JSON.stringify({errcode: 404, message: 'file not exist'}))
  res.end()
}
